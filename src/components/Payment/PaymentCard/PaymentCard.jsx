        ...
        <>
            ...
            <div className={styles.confirm}>
                <div className={styles.pay}>
                    <Link to='payment'><img className={styles.backButton} src={back} alt="Back" /></Link>
            ...
            <div className={styles.mainDiv}>
                <div className={styles.leftDiv}>
                    <div className={styles.left1}>
                        ...
                        <br />
                        <input className={styles.input} type="text" placeholder="Enter Card Number" />
                        <div style={{ float: 'left' }}>
                            <label htmlFor="html">Expiry</label>
                            <br />
                            <input className={styles.input2} type="number" placeholder="MM/YY" />
                        </div>
                        <div style={{ float: 'right' }}>
                            <label htmlFor="html">CVV</label>
                            <br />
                            <input className={styles.input3} type="number" placeholder="Enter CVV" />
                        </div>
                        <div style={{ clear: 'both' }}>
                            <label htmlFor="html">Name on Card</label>
                            <br />
                            <input className={styles.input} type="number" placeholder="Enter Card Number" />
                        </div>
                        <div className={styles.check}>
                            <input type="checkbox" id="check" />
                            <label for="check">Save this option securly for faster payment</label>
                        </div>
                        <Button className={styles.payButton} variant="contained">Proceed</Button>
                    </div>
                </div>
