			...
			<div className={styles.mainDiv}>
				<div className={styles.leftDiv}>
					...
					<div className={styles.left11}>
						...
						<Link to="" className={styles.left13}>
							Edit
						</Link>
					</div>
					<div className={styles.left11}>
					...
					<p className={styles.refund}>
						...
						<span>
							<Link>
								Host's House Rules, Airbnb's COVID-19 Safety Requirements
							</Link>
						</span>{" "}
						and the{" "}
						<span>
							<Link>Guest Refund Policy.</Link>
						</span>
					</p>
					<Button className={styles.payButton} variant="contained">
						<Link className={styles.paybtn} to="/paymentcard">
							Confirm and pay
						</Link>
					</Button>
				</div>
