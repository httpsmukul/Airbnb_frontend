            ...
            <div className='des-img-box'>
                ...
                <div>
                    <div className='right-box'>
                        <div className='img-small'><img src={img_1} alt='img' /></div>
                        <div className='img-small'><img className='img-end-up' src={img_1} alt="img" /></div>
                    </div>
                    <div className='right-box'>
                        <div className='img-small' ><img className='img' src={img_1} alt='img' /></div>
                        <div className='img-small'><img className='img-end-down' src={img_1} alt="img" /></div>
                    </div>
                </div>
            </div>
